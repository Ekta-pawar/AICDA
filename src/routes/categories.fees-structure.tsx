...
export const Route = createFileRoute("/categories/fees-structure")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Registration, road-tax and hypothecation fees explained." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <PageShell title="Fees Structure" subtitle="Registration, road-tax and hypothecation fees explained.">
      <Prose>
  ...
  <table className="w-full border-collapse text-[18px] text-gray-700">
    <tbody>
      ...
      <tr>
        <td
          colSpan={2}
          className="text-[20px] font-bold text-gray-700 py-2"
        >
