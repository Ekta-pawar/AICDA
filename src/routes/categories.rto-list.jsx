...
export const Route = createFileRoute("/categories/rto-list")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Complete list of Regional Transport Offices across India." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <PageShell title="RTO List" subtitle="Complete list of Regional Transport Offices across India.">
      <Prose>
  ...
  <ol className="list-decimal pl-8 space-y-1 text-[18px] text-gray-700">
    <li><strong>AN</strong> - Andaman & Nicobar Islands</li>
    ...
    <li><strong>CG</strong> - Chhattisgarh</li>
    <li><strong>DD</strong> - Daman and Diu</li>
    <li><strong>DL</strong> - Delhi</li>
    <li><strong>DN</strong> - Dadra and Nagar Haveli</li>
    ...
    <li><strong>JK</strong> - Jammu & Kashmir</li>
    <li><strong>KA</strong> - Karnataka</li>
    <li><strong>KL</strong> - Kerala</li>
    <li><strong>LD</strong> - Lakshadweep</li>
    ...
    <li><strong>UA</strong> - Uttarakhand</li>
