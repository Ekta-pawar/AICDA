...
export const Route = createFileRoute("/categories/other-state-vehicle")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Re-registration process when moving a vehicle to a new state." },
      { property: "og:title", content: "Other State Vehicle · AICDA" },
      { property: "og:description", content: "Re-registration process when moving a vehicle to a new state." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <PageShell title="Other State Vehicle" subtitle="Re-registration process when moving a vehicle to a new state.">
      <Prose>
