...
export const Route = createFileRoute("/categories/transfer-fees")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "State-wise ownership transfer fee schedules updated for the current year." },
      { property: "og:title", content: "Transfer Fees · AICDA" },
      { property: "og:description", content: "State-wise ownership transfer fee schedules updated for the current year." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <PageShell title="Transfer Fees" subtitle="State-wise ownership transfer fee schedules updated for the current year.">
      <Prose>
