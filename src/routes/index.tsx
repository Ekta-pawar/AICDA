...
function Index() {
  const features = [
    { icon: Users, title: "Members", text: "Dealers, showrooms and pre-owned specialists across every state." },
    { icon: ShieldCheck, title: "Consumer Trust", text: "Code-of-conduct and grievance redressal for buyers nationwide." },
    { icon: FileText, title: "RTO Assistance", text: "Transfer, NOC, duplicate RC and registration made simple." },
    { icon: Award, title: "Policy Advocacy", text: "Voice of the trade before Ministry of Road Transport & Highways." },
  ];
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="max-w-2xl">
              ...
              >
                ...
                <Link to="/directory" className="px-6 py-3 rounded-lg ring-1 ring-primary-foreground/40 font-bold hover:bg-primary-foreground/10 transition">
...
<h4 className="mb-[9px] font-bold">
 ...
 <p className="mb-[9px]">If you have any problem regarding your vehicle in any of the Transport Authority, please contact the concerned MLO along with your identity card & discuss the problem with him. In case it is not resolved, contact the President and he shall pursue the matter through secretary along with you to solve the problem through proper channel.</p>
<h3 className="mb-[9px] font-bold">
...
Mobile: 9818691000,9810027829</h4>
            ...
            >
              <Link to="/association-events" className="tilt-3d group rounded-2xl border border-border bg-card p-6 shadow-[var(--shadow-card)]">
                <Newspaper className="w-8 h-8 text-primary mb-3" />
                <div className="text-xl font-bold group-hover:text-primary transition">Latest Events</div>
                <p className="text-sm text-muted-foreground mt-2">Annual convention, regional meets, dealer skill workshops and industry conclaves.</p>
              </Link>
              <Link to="/political-achievements" className="tilt-3d group rounded-2xl border border-border bg-card p-6 shadow-[var(--shadow-card)]">
                <Award className="w-8 h-8 text-primary mb-3" />
                <div className="text-xl font-bold group-hover:text-primary transition">Political Achievements</div>
                <p className="text-sm text-muted-foreground mt-2">Policy wins on GST rationalisation, scrappage norms and dealer licensing reforms.</p>
              </Link>
            </motion.div>
          </div>
        </div>
