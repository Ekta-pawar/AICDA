...
export const Route = createFileRoute("/categories/new-vehicle")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Registration procedure for a newly purchased vehicle." },
    ],
  }),
  component: Page,
});
...
<li>H.P.A. Form No.34 (If you want H.P.A)
</li>
</ul>
<p>Temporary Registration if sold by out side Dealers Fitness No.38 in Commercial Vehicle etc.
