...
export const Route = createFileRoute("/categories/transfer-ownership")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Step-by-step guide to transferring vehicle ownership at your RTO." },
      { property: "og:title", content: "Transfer Ownership · AICDA" },
      { property: "og:description", content: "Step-by-step guide to transferring vehicle ownership at your RTO." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <PageShell title="Transfer Ownership" subtitle="Step-by-step guide to transferring vehicle ownership at your RTO.">
      <Prose>
        <h2 className="pl-[20px] ">
  ABOUT TRANSFER OWNERSHIP
</h2>
  ...
  <p className="text-[17px] leading-8">
    To be applied on Form 31 by the successor of deceased (nearest legal heir)
    supported with Death certificate (Affidavit of declaring death) and details
    of legal heirs no objection certification of all legal heirs for transfer,
    (Proposed owner). Address proof, Ration Card (Photocopy) and insurance in
    the name of proposed owner, with prescribed fee pollution
    certificate(certified copy).
  </p>

  <h2 className="text-[18px] font-medium uppercase mt-6 mb-5">
